...
[![GitHub Release](https://img.shields.io/github/v/release/pbi-tools/pbi-tools?label=Latest%20Release)](https://github.com/pbi-tools/pbi-tools/releases/latest)

{% include callout.html content="Releases since Nov 2020 are maintained on [GitHub](https://github.com/pbi-tools/pbi-tools/releases)." type="primary" %}
